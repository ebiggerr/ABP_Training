...
export class EventServiceProxy {
    ...
    cancelRegistration(body: GuidEntityDto | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCancelRegistration(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<EventListDto> {
    ...
    protected processGet(response: HttpResponseBase): Observable<EventListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EventListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @param isCancelled (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAll(keyword: string | null | undefined, isCancelled: boolean | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<EventListDtoPagedResultDto> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<EventListDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    create(body: CreateEventInput | undefined): Observable<EventListDto> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<EventListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: CreateEventInput | undefined): Observable<EventListDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<EventListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TaskServiceProxy {
     ...
     * @return Success
     */
    getAll(): Observable<TaskListDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TaskListDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TaskListDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<TaskListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TaskListDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TaskListDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    addNewTask(body: RequestDto | undefined): Observable<Task> {
        let url_ = this.baseUrl + "/api/services/app/Task/AddNewTask";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddNewTask(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddNewTask(<any>response_);
                } catch (e) {
    ...
    protected processAddNewTask(response: HttpResponseBase): Observable<Task> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    updateTask(body: TaskListDto | undefined): Observable<Task> {
    ...
    protected processUpdateTask(response: HttpResponseBase): Observable<Task> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TaskListDtoListResultDto implements ITaskListDtoListResultDto {
    items: TaskListDto[] | undefined;

    constructor(data?: ITaskListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TaskListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new TaskListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): TaskListDtoListResultDto {
        const json = this.toJSON();
        let result = new TaskListDtoListResultDto();
        result.init(json);
        return result;
...
export interface ITaskListDtoListResultDto {
    items: TaskListDto[] | undefined;
}
